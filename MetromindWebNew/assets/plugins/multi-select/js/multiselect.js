!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonWidth: '100%',
            buttonContainer: '<div class="btn-group"  style="display:block"/>',
            ...
            nonSelectedText: 'Select any Specialization',            
            nSelectedText: 'selected'
        },
        
        // Templates.
        templates: {
            button: '<button type="button" class="multiselect dropdown-toggle" data-toggle="dropdown" style="text-transform: none;font-weight: 100;overflow-x: hidden;"></button>',
            ul: '<ul class="multiselect-container dropdown-menu"  style="width:100%;height:200px !important; overflow-y: scroll !important;"></ul>',
