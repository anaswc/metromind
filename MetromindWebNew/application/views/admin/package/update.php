        ...
        <div class="container-fluid">
            ...
            <div class="row"> 
                ...
                <?php } ?>
					...
					<?php echo form_open_multipart('admin/package/update/'.$package_item['packageId']); ?>
<input type="hidden" name="packageId " value="<?php echo $package_item['packageId']  ?>">
<input type="hidden" name="returnUrl" value="<?php echo $this->input->get('returnUrl')?>">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="packageName" id="packageName" value="<?php echo $package_item['packageName']?>" class="form-control"  required>
                            </div>
                          </div>
                        </div>
                       <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <textarea rows="3" name="packageDescription" id="packageDescription" class="form-control" ><?php echo $package_item['packageDescription'] ?></textarea>
                            </div>
                          </div>
                        </div>
                         ...
                         <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="packageDuration" id="packageDuration" value="<?php echo $package_item['packageDuration'] ?>" class="form-control"  required>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="noOfSession" id="noOfSession" value="<?php echo $package_item['noOfSession'] ?>" class="form-control"  required>
                            </div>
                          </div>
                        </div>
            ...
            <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="packagePrize" id="packagePrize" value="<?php echo $package_item['packagePrize'] ?>" class="form-control"  required>
                            </div>
                          </div>
                        </div>
