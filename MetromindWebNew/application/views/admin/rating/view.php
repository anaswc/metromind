...
<html lang="en">
  ...
  <head>
    ...
    <title>Metro Mind-View Rating</title>
  ...
  <body  class="horizontal-fixed fixed">
	...
	<script>
    function Cancel(){
        document.location.href="<?php echo base_url('admin/rating'); ?>";
    }
    </script> 
                ...
                <div class="row">
                    <div class="col-lg-12 p-0">
                        <div class="main-header">
                            <h4><?php echo $this->rating_model->firstName?></h4>
                            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                <li class="breadcrumb-item"><a href="<?php echo base_url('admin/dashboard'); ?>"><i class="icofont icofont-home"></i></a>
                                </li>
                                <li class="breadcrumb-item"><a href="<?php echo base_url('admin/rating'); ?>">Rating</a>
                                </li>
                                <li class="breadcrumb-item"><?php echo $this->rating_model->firstName?>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="row"align="center">
                                   <?php  
													  if(count($rating_item)) :
														  foreach($rating_item as $row):
													?>
                                        ...
                                        <div class="row">
											...
											<tr>
												...
												<tr>
											<td>
                                                 <span class="txt-muted"> Rating </td><td>: <?php echo $row['rating']?> </span>
                                                   </td>
												  </tr>
                                                </div>
                                                <div class="col-lg-12">
												<tr>
											<td>
                                                 <span class="txt-muted"> Review </td><td>: <?php echo $row['review']?> </span>
                                                   </td>
												  </tr>
                                                </div>
