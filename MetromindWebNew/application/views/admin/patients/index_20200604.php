                ...
                <div class="card-block">
                        ...
                        <input type="hidden"  name="clsaxPatient_submitted" value=""> 
                         	<div class="form-group m-r-15">
                                ...
                                <div class="form-group m-r-15">
                                <input type="text" class="form-control input-rounded" name="patientEmail" placeholder="Patient email"  value="<?php echo $this->patients_model->
patientEmail
?>"></div>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th width="2%" height="24" class="nosort">
                      	<input type="checkbox" name="chkAll" value="checkbox" class="checkall"   onClick="selectAll(patientId, this);"> 			  
                      </th> 
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td  valign="top" class="rowcontent">
						<input type="checkbox" name="patientId[]" value="<?php echo $row["patientId"]?>" id="patientId" onCLick='resetChkBox(patientId, chkAll);changeCheckedColor(frmPatientList.patientId);' />
					  </td>	
                      ...
                      <td>
                      	<?php
							if($row['profileImgUrl']<>"" &&  file_exists(AXUPLOADPATIENTSPATH.$row['profileImgUrl'])){?>
							 <span><img src="<?php echo HTTP.AXUPLOADPATIENTSPATH.$row['profileImgUrl']?>" width="60" height="60" /></span>
						 <?php }?>
                      </td>
