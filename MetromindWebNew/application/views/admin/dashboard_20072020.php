                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a class="waves-effect waves-dark" href="<?php echo base_url();?>admin/specialities"><i class="icon-arrow-right"></i>Specialities</a></li>
                         ...
                         <li><a class="waves-effect waves-dark" href="<?php echo base_url();?>admin/symptom"><i class="icon-arrow-right"></i>Symptoms</a></li>
                          ...
                          <li><a class="waves-effect waves-dark" href="<?php echo base_url();?>admin/patients"><i class="icon-arrow-right"></i>Patients</a></li>

                           <li><a class="waves-effect waves-dark" href="<?php echo base_url();?>admin/appointment"><i class="icon-arrow-right"></i>Appointments</a></li>
                        ...
                        <div class="media">
                            ...
                            <div class="media-middle" align="center">
                                ...
                                <div class="new-orders">
                                   ...
                                   <img src="<?php echo base_url();?>dashboard_images/newrequest.png" style="width: 75px;height: 100px" > 
