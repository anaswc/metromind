                   ...
                   foreach ($symptoms as $row1) :
					...
					endforeach;
                        ...
                        <div class="col-md-6 col-xs-12">
						  ...
						  </div><div align="left"><strong><strong>Availability</strong></strong></div>
						  <br>
						 <div class="row"> 
               <div class="col-lg-8"style="margin-left: 204px;" >
                  <div class="card">
                    ...
                    foreach ($available_item as $row) :
                          ...
                          <div class="form-group row">
                            <div class="col-sm-3">
                                                     <span class="txt-muted"> <?php echo $row['availableDay']?> </span>
                                                     </div>
                          </div>
                        </div>
						<div class="col-md-3 col-xs-12">
                          <div class="form-group row">
                            <div class="col-sm-3">
                                                     <span class="txt-muted"> <?php echo $row['availableSession']?> </span>
                                                     </div>
                          </div>
                        </div>
						<div class="col-md-3 col-xs-12">
                          <div class="form-group row">
                            <div class="col-sm-3">
                                                     <span class="txt-muted"> <?php echo $row['availableStartTime']?> </span>
                                                    </div>
                          </div>
                        </div>
						<div class="col-md-3 col-xs-12">
                          <div class="form-group row">
                            <div class="col-sm-3">
                                                     <span class="txt-muted"> <?php echo $row['availableEndTime']?> </span>
                                                     </div>
                          </div>
                        </div>
