      ...
      <div class="col-lg-12" >
        <div class="card">
          ...
          <div class="card-block">
            ...
            <div class="col-md-6 col-xs-12">
              <div class="form-group row">
                <label for="input-rounded" class="col-sm-12 form-control-label">Doctor Image</label>
                <div class="col-sm-5">
                  <input type = "file" name ="doctorImageUrl" id="doctorImageUrl" class="form-control"  size = "20" />
                </div>
            ...
            <div class="col-md-6 col-xs-12">
              <div class="form-group row">
                ...
                <div class="col-sm-6"> Verified
                  <input type="radio" name="isVerifiedLicense" value="1" class="" required>
                </div>
                <div class="col-sm-6"> Not Verified
