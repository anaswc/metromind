...
<?php 
$availtimsun=array();
$availtimsun=$this->doctor_model->getItem_day($this->doctor_model->doctorId,$day1);
?>
...
<div><h6>&nbsp;</h6></div>
 ...
 <div class="col-sm-3">
   ...
   <?php 
$availtimeday2=array();
$availtimeday2=$this->doctor_model->getItem_day($this->doctor_model->doctorId,$day2);
?>
<span style="color: green">
...
<?php 
$availtimeday3=array();
$availtimeday3=$this->doctor_model->getItem_day($this->doctor_model->doctorId,$day3);
?>
<span style="color: green">
...
<?php 
$availtimeday4=array();
$availtimeday4=$this->doctor_model->getItem_day($this->doctor_model->doctorId,$day4);
?>
<span style="color: green">
  ...
  <?php 
$availtimeday5=array();
$availtimeday5=$this->doctor_model->getItem_day($this->doctor_model->doctorId,$day5);
?>
<span style="color: green">
...
<?php 
$availtimeday6=array();
$availtimeday6=$this->doctor_model->getItem_day($this->doctor_model->doctorId,$day6);
?>
<span style="color: green">
 ...
 <div class="col-sm-3">
    ...
    <?php 
$availtimeday7=array();
$availtimeday7=$this->doctor_model->getItem_day($this->doctor_model->doctorId,$day7);
?>
<span style="color: green">
