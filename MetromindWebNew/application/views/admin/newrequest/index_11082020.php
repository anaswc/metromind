...
function submitPage(){
	...
	frm.action		= "<?php echo base_url()?>admin/newrequest"
                ...
                <table cellspacing="0" id="advanced-table" class="table  table-striped table-bordered nowrap">
                  ...
                  <tbody>
					...
					$completed=$row["isCompleted"];
						...
						$fixedtime="04:00:00";
						if($row['timeDifference']>=$fixedtime)
						{
                    ...
                    <tr <?php echo $rowcolor?>>
                      ...
                      <td ><?php echo $cnt?></td>
                      <td> <a href="<?php echo base_url('admin/newrequest/view/'.$row["appointmentId"])  ?>" data-original-title="View" ><i class="ion-eye"></i> </a>&nbsp;
                       <?php if($completed<>1){?>
                      <a href="<?php echo  base_url('admin/newrequest/update/'.$row["appointmentId"]).'/'  ?>?returnUrl=<?php echo urlencode(getCurrentPageURL())?>"  data-original-title="Edit" ><i class="icofont icofont-edit"></i> </a> 
                     <?php }
