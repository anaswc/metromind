...
function validateVideoId(videoid){   
    ...
    $.ajax(
        {   
            ...
            data : {videoId:videoid}, // Data sent to server, a set of key/value pairs (i.e. form fields and values)
            dataType : "JSON",
            ...
            <form name="frmvideoCreate;" action="<?php echo base_url('admin/videos/create');?>"  method="post" accept-charset="utf-8" onSubmit="return validateVideoId();"> 
                        ...
                        <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="videoId" id="videoId" class="form-control" value="" required onBlur="validateVideoId(this.value)">
                            </div>
                          </div>
                        </div>
