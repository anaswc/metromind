            ...
            <div class="col-sm-12 p-0">
              <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                      ...
                      <li class="breadcrumb-item"><a href="#">Edit Admin user</a></li>
                    </ol>
                  </div>
            </div>
            <div class="row"> 
                ...
                <?php } ?>
					...
					<?php echo form_open_multipart('admin/adminuser/update/'.$admin_item['adminId ']); ?>
<input type="hidden" name="adminId" value="<?php echo $admin_item['adminId']  ?>">
<input type="hidden" name="returnUrl" value="<?php echo $this->input->get('returnUrl')?>">

                        <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            <label for="input-rounded" class="col-sm-12 form-control-label">Admin Type<span class="mandatory">* </span> </label>
                            <div class="col-sm-6">
                             <select name="adminType" class="form-control" id="adminType" required >
                        ...
                        <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            <label for="input-rounded" class="col-sm-12 form-control-label">Admin name<span class="mandatory">* </span> </label>
                            <div class="col-sm-6">
                              <input type="text" name="adminName" id="adminName" value="<?php echo $admin_item['adminName']  ?>" class="form-control"  required>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            <label for="input-rounded" class="col-sm-12 form-control-label">Username</label>
                            <div class="col-sm-6">
                              <input type="text" name="userName" id="userName" class="form-control" value="<?php echo $admin_item['userName']  ?>" required onBlur="validateUsername(this.value)">
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            <label for="input-rounded" class="col-sm-12 form-control-label">Password</label>
                            <div class="col-sm-6">
                              <input type="text" name="password" id="password" class="form-control" value="<?php echo $this->encryption->decrypt($admin_item['password'])  ?>" required>
                            </div>
                          </div>
                        </div>
                         ...
                         <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="adminEmail" id="adminEmail" class="form-control" value="<?php echo $admin_item['adminEmail']  ?>" required>
                            </div>
                          </div>
                        </div>
                         ...
                         <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="adminPhone" id="adminPhone" class="form-control" value="<?php echo $admin_item['adminPhone']  ?>" required>
                            </div>
                          </div>
                        </div>
