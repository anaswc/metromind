...
<form name="frmAdminCreate;" action="<?php echo base_url('admin/adminuser/create');?>"  method="post" accept-charset="utf-8" onSubmit="return validateUsername();"> 
          ...
          <div class="col-md-12 col-xs-12">
                        ...
                        <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="adminName" id="adminName" value="<?php echo $this->adminuser_model->adminName ?>" class="form-control"  required>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="userName" id="userName" class="form-control" value="<?php echo $this->adminuser_model->userName ?>" onBlur="validateUsername(this.value)" required>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="password" id="password" class="form-control" value="<?php echo $this->adminuser_model->password ?>" required>
                            </div>
                          </div>
                        </div>
                         ...
                         <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="adminEmail" id="adminEmail" class="form-control" value="<?php echo $this->adminuser_model->adminEmail ?>" required>
                            </div>
                          </div>
                        </div>
                         ...
                         <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="adminPhone" id="adminPhone" class="form-control" value="<?php echo $this->adminuser_model->adminPhone ?>" required>
                            </div>
                          </div>
                        </div>
