...
<html lang="en">
  ...
  <head>
    ...
    <title>Metro Mind-View Prescription</title>
  ...
  <body  class="horizontal-fixed fixed">
	...
	<script>
    function Cancel(){
        document.location.href="<?php echo base_url('admin/Prescription'); ?>";
    }
    </script> 
                ...
                <div class="row">
                    <div class="col-lg-12 p-0">
                        <div class="main-header">
                            <h4><?php echo $this->prescription_model->firstName?></h4>
                            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                <li class="breadcrumb-item"><a href="<?php echo base_url('admin/dashboard'); ?>"><i class="icofont icofont-home"></i></a>
                                </li>
                                <li class="breadcrumb-item"><a href="<?php echo base_url('admin/prescription'); ?>">Prescription</a>
                                </li>
                                <li class="breadcrumb-item"><?php echo $this->prescription_model->firstName?>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="row" align="center">
                                   <?php  
													  if(count($prescription_item)) :
														  foreach($prescription_item as $row):
													?>
                                   <div class="col-md-12 col-xs-12">
                                        <div class="row">
											...
											<tr>
											<td>
                                                 <span class="txt-muted"> Patient Name </td><td>: <?php echo $row['firstName']?> </span>
                                                  </td>
												  </tr>
                                                </div>
                                               <div class="col-lg-12">
											<tr>
                                                 <span class="txt-muted"><td> Doctor Name </td><td>: <?php echo $row['doctorName']?> </span>
                                                  </td>
												  </tr>
                                                </div>
												...
												<tr>
											<td>
                                                 <span class="txt-muted"> Prescription Notes </td><td>: <?php echo nl2br($row['prescriptionNotes']);?> </span>
                                                   </td>
												  </tr>
                                                </div>
												...
												<tr>
											<td>
                                                <span class="txt-muted"> Insert Date</td><td>: <?php echo $row['insDate']?> </span>
                                                    </td>
												  </tr>
                                                </div>
                                                 <div class="col-lg-12">
												 <!--<tr>
											<td>
                                                <span class="txt-muted"> Payment Id</td><td>: <?php echo$row['paymentId']?> </span>
                                                    </td>
												  </tr>-->
                                                </div>
                                                  <div class="col-lg-12">
												  <tr>
											<td>
                                                <span class="txt-muted"> Total Amount</td><td>: <?php echo $row['totalAmount']?> </span>
												 </td>
												  </tr>
                                                   </table>
                                                </div>
