      ...
      <div class="col-sm-12 p-0">
        <div class="main-header">
          ...
          <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
            ...
            <li class="breadcrumb-item"><a href="#">Add Symptoms</a></li>
          </ol>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12" >
          <div class="card">
            ...
            <div class="card-block">
              ...
              <?php } ?>
              <?php echo validation_errors(); ?> <?php echo form_open_multipart('admin/symptom/create'); ?>
              <div class="col-md-12 col-xs-12">
                <div class="form-group row">
                  <label for="input-rounded" class="col-sm-12 form-control-label">Symptom Name<span class="mandatory">* </span> </label>
                  <div class="col-sm-6">
                    <input type="text" name="symptomName" id="symptomName" value="<?php echo $this->symptom_model->symptomName ?>" class="form-control" required >
                  </div>
                </div>
              </div>
              <div class="col-md-12 col-xs-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" id="colorCode" name="colorCode" class="form-control" value="<?php echo $this->symptom_model->colorCode ?>">
                  </div>
                </div>
              </div>
              <!--<div class="col-md-12 col-xs-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" id="opacity" name="opacity" class="form-control" value="<?php echo $this->symptom_model->opacity ?>">
                  </div>
                </div>
              </div>-->
              <div class="col-md-12 col-xs-12">
              ...
              <div class="col-md-12 col-xs-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <textarea name="description" rows="4" id="description" class="form-control" > <?php echo $this->symptom_model->description ?></textarea>
                  </div>
                </div>
              </div>
              <div class="col-md-12 col-xs-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-3">
                    <input type = "file" name ="symptomImage" class="form-control" id="symptomImage" size = "20" />
                  </div>
              ...
              <div class="col-md-12 col-xs-12">
                <div class="form-group row">
                  <div class="col-sm-6">
                    <input type="checkbox" name="status" id="status" <?php if($this->symptom_model->status == 1){ ?> checked <?php } ?> value="1">  
