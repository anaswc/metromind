    ...
    <nav class="navbar navbar-static-top"> 
      ...
      <div class="navbar-custom-menu">
        ...
        <ul class="top-nav">
          ...
          <li class="dropdown"> <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image"> <span><img class="img-circle " src="<?php echo base_url('assets/images/avatar-1.png')?>" style="width:40px;" alt="User Image"></span> <span><i class=" icofont icofont-simple-down"></i></span> </a>
