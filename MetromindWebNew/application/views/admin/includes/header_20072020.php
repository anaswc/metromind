...
global $arrAdminType;
          ?>
        <li class="dropdown"> <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image"> <span><img class="img-circle " src="<?php echo base_url('assets/images/avatar-1.png')?>" style="width:40px;" alt="User Image"></span> <span><?php echo $arrAdminType[$this->session->userdata('adminType')]; ?><i class=" icofont icofont-simple-down"></i></span> </a>
  ...
  <section class="sidebar" id="sidebar-scroll">
    ...
    <ul class="sidebar-menu">
      ...
      <ul class="treeview-menu">
        ...
        <li class="treeview"><a href="<?php echo base_url('admin/newrequest')?>"><span>New Requests</span></a></li>
