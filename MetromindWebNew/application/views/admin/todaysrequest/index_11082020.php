...
function submitPage(){
	...
	frm.action		= "<?php echo base_url()?>admin/todaysrequest"
    ...
    <div id="wrapper">
      ...
      <input type="text" class="form-control input-rounded" name="firstName" placeholder="Patient Name"  value="<?php echo $this->appointments_model->firstName?>"></div>
					   ...
					   <option value="" <?php  if($this->appointments_model->appointmentSession==""){ echo "selected"; }?>>--Select--</option>
                           <option value="Morning" <?php  if($this->appointments_model->appointmentSession=="Morning"){ echo "selected"; }?>>Morning</option>
                            <option value="After Noon" <?php  if($this->appointments_model->appointmentSession=="After Noon"){ echo "selected"; }?>>After Noon</option>
                           <option value="Evening" <?php  if($this->appointments_model->appointmentSession=="Evening"){ echo "selected"; }?>>Evening</option>
      ...
      <input type="date" class="form-control input-rounded" name="appointmentDate" placeholder="Appointment Date"  value="<?php echo date('Y-m-d')?>"></div>
                            ...
                            <button type="button" class="btn btn-mini btn-primary waves-effect waves-light m-r-30" onclick="javascript:document.location.href='<?php echo base_url('admin/todaysrequest'); ?>';">Cancel</button>
                        </form>
       	 			</div>
              ...
              <div class="table-responsive">
                ...
                <input type="hidden"  	name="appointmentIdIds" value=""> 
                ...
                <table cellspacing="0" id="advanced-table" class="table  table-striped table-bordered nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td ><?php echo $cnt?></td>
                      <td> <a href="<?php echo base_url('admin/todaysrequest/view/'.$row["appointmentId"])   ?>" data-original-title="View" ><i class="ion-eye"></i> </a>&nbsp;
                       <?php if($completed<>1){?>
                      <a href="<?php echo  base_url('admin/todaysrequest/update/'.$row["appointmentId"]).'/'  ?>?returnUrl=<?php echo urlencode(getCurrentPageURL())?>"  data-original-title="Edit" ><i class="icofont icofont-edit"></i> </a> 
                     <?php }
