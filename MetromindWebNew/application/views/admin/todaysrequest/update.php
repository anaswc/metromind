								...
								<div class="card-block">
									<table class="table table-borderless table-xs">
                                      ...
                                      ?>
											...
											<tr>
												<td><?php echo date('h:i A',strtotime($row['appointmentStartTime'])).' - '.date('h:i A',strtotime($row['appointmentEndTime'])) ?></td>
												...
												<div class="form-group row">
													<div align="center">
														...
														<button type="button"
															...
															onclick="javascript:document.location.href='<?php echo base_url('admin/newrequest'); ?>';">Cancel</button>
													</div>
												</div>
											</div>
