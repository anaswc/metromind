...
<body class="horizontal-fixed fixed">
                ...
                <form action="<?php echo base_url('admin/cms/banner/' . $banner_item[0]['bannerId']); ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                  ...
                  <div class="col-md-6 col-xs-12" style="clear:left">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-5">
                        <input type="file" name="bannerImgUrl" id="bannerImgUrl" class="form-control" />
                        <?php
                      if ($banner_item[0]['bannerImgUrl'] <> "" &&  file_exists(AXUPLOADBANNERPATH . $banner_item[0]['bannerImgUrl'])) { ?>
                        <span><a href="<?php echo base_url() . $banner_item[0]['bannerImgUrl'] ?>" target="_blank"><img src="<?php echo base_url() . AXUPLOADBANNERPATH . $banner_item[0]['bannerImgUrl'] ?>" width="60" height="60" /></a></span>
                      <?php } ?>
                      </div>
  ...
  <!--<script src="<?php // echo base_url('assets/js/common-pages.js'); 
                    ?>"></script>-->
