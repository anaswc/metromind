...
<html lang="en">
  ...
  <head>
    ...
    <title>Metro Mind-content Management</title>
            ...
            <div class="col-sm-12 p-0">
              <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                      ...
                      <li class="breadcrumb-item"><a href="#">Content Management System</a></li>
                    </ol>
                  </div>
            </div>
            <div class="row"> 
                <div class="col-lg-12" >
                  <div class="card">
                   ...
                   <?php if ($this->session->flashdata('success')) { ?>
					...
					<form action="<?php echo base_url('admin/cms/create');?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            <label for="input-rounded" class="col-sm-12 form-control-label">Page Title<span class="mandatory">* </span> </label>
                            <div class="col-sm-6">
                              <input type="text" name="pageName" value="" class="form-control" required>
                            </div>
                          </div>
                        </div>
						<div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                    <textarea class="input-xlarge ckeditor" name="description" id="description" style="width:50% !important; height:200px;"></textarea>
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                          <textarea class="input-xlarge ckeditor" name="shortDescription" id="shortDescription" style="width:50% !important; height:200px;"></textarea>
                            </div>
                          </div>
                        </div>
