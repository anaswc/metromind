                ...
                <div class="col-lg-12" >
                  <div class="card">
                   ...
                   <?php if ($this->session->flashdata('success')) { ?>
					...
					<form action="<?php echo base_url('admin/cms/update/'.$cms_item['pageId']);?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                       <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            <label for="input-rounded" class="col-sm-12 form-control-label">page Name<span class="mandatory">* </span> </label>
                            <div class="col-sm-6">
                              <input type="text" name="pageName" value="<?php echo $cms_item['pageName']?>" class="form-control" required>
                            </div>
                          </div>
                        </div>
                       ...
                       <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                    <textarea class="input-xlarge ckeditor" name="description" id="description"  style="width:50% !important; height:200px;"><?php echo $cms_item['description']?></textarea>
                            </div>
						  ...
						  <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                             <label for="input-rounded" class="col-sm-12 form-control-label">Short Description&nbsp; </label>
                            <div class="col-sm-6">
                          <textarea class="input-xlarge ckeditor" name="shortDescription" id="shortDescription" style="width:50% !important; height:200px;"><?php echo $cms_item['shortDescription']?></textarea>
                            </div>
                          </div>
                        </div>
