...
function validateUsername(userName){   
    ...
    $.ajax(
        {   
            url: "<?php echo base_url(); ?>admin/adminuser/checkUsername", 
            type: "POST",             // Type of request to be send, called as method
            data : {userName:userName}, // Data sent to server, a set of key/value pairs (i.e. form fields and values)
            dataType : "JSON",
...
function getdoctorPackage(doctorId){   
	var formData = new FormData();
	formData.append('doctorId', doctorId); 
	
	$.ajax(
		{	
			url: "<?php echo base_url(); ?>admin/subscription/getDoctorPackages", 
			type: "POST",             // Type of request to be send, called as method
			data : {doctorId:doctorId}, // Data sent to server, a set of key/value pairs (i.e. form fields and values)
			dataType : "JSON",
			success:function(data)
			{	
				var html = '';
                    var i;
					 html += '<select class="form-control" name="packageId">';
					  html += '<option value="" >--Package--</option>';
                    for(i=0; i<data.length; i++){
                        html += '<option value="'+data[i].packageId+'">'+data[i].packageName+'</option>';
                    } 
					 html += '</select>'; 
					 document.getElementById("packageId").innerHTML=html;
            ...
            <div class="col-sm-12 p-0">
              <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                      ...
                      <li class="breadcrumb-item"><a href="#">Add Subscriptions</a></li>
                    </ol>
                  </div>
            </div>
            <div class="row"> 
...
<form name="frmAdminCreate;" action="<?php echo base_url('admin/subscription/create');?>"  method="post" accept-charset="utf-8" onSubmit="return validateUsername();"> 


<div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            <label for="input-rounded" class="col-sm-12 form-control-label">Doctor<span class="mandatory">* </span> </label>
                            <div class="col-sm-6">
                             <select name="doctorId" class="form-control" id="doctorId" required onchange="getdoctorPackage(this.value)">
          ...
          <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            <label for="input-rounded" class="col-sm-12 form-control-label">Package<span class="mandatory">* </span> </label>
                            <div class="col-sm-6">
                        ...
                        <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            <label for="input-rounded" class="col-sm-12 form-control-label">Patient<span class="mandatory">* </span> </label>
                            <div class="col-sm-6">
                             <select name="patientId" class="form-control" id="patientId" required >
                                    <option value="">--Select--</option>
                        ...
                        <div class="col-md-12 col-xs-12">
                          <div class="form-group row">
                            <label for="input-rounded" class="col-sm-12 form-control-label">No:of sessions<span class="mandatory">* </span> </label>
                            <div class="col-sm-6">
                              <input type="text" name="noOfSession" id="noOfSession" value="<?php echo $this->subscription_model->noOfSession ?>" class="form-control"  required>
                            </div>
                          </div>
                        </div>
