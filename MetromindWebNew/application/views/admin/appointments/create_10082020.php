	  ...
	  if(appointmentSession == '' )
  {
   ...
   var flag;
	...
	if(flag ==1){
		...
		if(appointmentSession =='After Noon' ){
        ...
        <div class="container-fluid">
            ...
            <div>
                ...
                <div class="row">
                    ...
                    <form name="frmAppoinment" id="frmAppoinment" method="post" action="<?php echo base_url('admin/appointment/create/') ?>" onSubmit="return validateAppointment(event)">
                    <div class="col-xl-8 col-lg-7 col-md-6 pull-lg-5 pull-xl-4 pull-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-header-text"> <i class="icofont icofont-tasks-alt m-r-5"></i>Create appoinment</h5>
                                ...
                                <?php
								 ...
								 if(count($doctorList)>0){
									foreach($doctorList as $doc){
									 ?>
                                <option value="<?php echo $doc['doctorId'] ?>"><?php echo $doc['doctorName'] ?></option>
                                <?php }
								}?>
                              </select>
                              </td>
                              <td>
                              <select name="patientId" id="patientId"  class="form-control" onChange="checkPatient_availability()">
                                ...
                                <?php
								 ...
								 if(count($patientList)>0){
									foreach($patientList as $pat){
									 ?>
                                <option value="<?php echo $pat['patientId'] ?>"><?php echo $pat['firstName']." ".$pat['lastName'] ?></option>
                                <?php }
								}?>
                              </select>
                              </td>
