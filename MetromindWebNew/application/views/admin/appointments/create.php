				...
				<div>
					...
					<div class="row">
						...
						<form name="frmAppoinment" id="frmAppoinment" method="post"
							action="<?php echo base_url('admin/appointment/create/') ?>"
								...
								<div class="card">
									<div class="card-header">
										<h5 class="card-header-text"> <i
												class="icofont icofont-tasks-alt m-r-5"></i>Create appoinment</h5>
									 ...
									 ?>
																...
																<td>
																	<select name="patientId" id="patientId"
																		class="form-control"
																		onChange="checkPatient_availability()">
								 ...
								 if(count($patientList)>0){
									foreach($patientList as $pat){
									 ?>
																		<option value="<?php echo $pat['patientId'] ?>">
																			<?php echo $pat['firstName']." ".$pat['lastName']." "."(".$pat['uniqueId'].")" ?>
																		</option>
																		<?php }
								}?>
																	</select>
