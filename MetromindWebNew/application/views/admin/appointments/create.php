                                ...
                                <?php
								 ...
								 if(count($patientList)>0){
									foreach($patientList as $pat){
									 ?>
                                <option value="<?php echo $pat['patientId'] ?>"><?php echo $pat['firstName']." ".$pat['lastName']." "."(".$pat['uniqueId'].")" ?></option>
                                <?php }
								}?>
                              </select>
                              </td>
...
<td> <input type="time" name="appointmentStartTime" id="appointmentStartTime" min="08:59:00" max="20:59:00" class="form-control" value="09:00:00" required></td>
  ...
  <input type="checkbox"  name="isCredit" id="isCredit" value="1" checked>
