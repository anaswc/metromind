...
<html lang="en">
  ...
  <body  class="horizontal-fixed fixed">
	...
	<script>
    function Cancel(){
        document.location.href="<?php echo base_url('admin/appointment'); ?>";
    }
    </script> 
 ...
 Appointment					</h4>
				<ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                 <li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/dashboard"><i class="icofont icofont-home"></i></a></li>
                   	<li class="breadcrumb-item"><a href="<?php echo base_url('admin/appointment/index'); ?>"> Appointment List</a>	
