...
{/*
  var frm       = document.frmpatientCreditList;
  var checkFlag   = 0;
  var selectedValue = "";   
  if(frm.elements["patientCreditId[]"]!=null)
  {
    selectedValue   = getCheckedItem(frm,"patientCreditId[]");
    if (frm.elements["patientCreditId[]"].checked == true) 
    {   
      checkFlag = 1;
    }
    for(var i=0;i<frm.elements["patientCreditId[]"].length;i++) 
    {
      if (frm.elements["patientCreditId[]"][i].checked) 
      { 
        checkFlag++;    
      }   
    }   
  ...
  { 
    if (action == "DELETE") 
    {
      ...
      {
        frm.patientCreditIds.value  = selectedValue;
    ...
    else if (action == "EDIT") 
    {
      ...
      {
        frm.patientCreditId.value = selectedValue;
        frm.action.value  = action;
...

    {
...

      {
                ...
                frm.patientCreditIdpatientCreditIds.value  = selectedValue;
...
function submitPage(){
  var frm     = document.frmpatientCreditList;
  var pageSize  = frm.clsaxpatientCreditId_pageSize.value;
  frm.action    = "<?php echo base_url()?>admin/patientcredits"
...
{
  var frm= document.frmpatientcreditsearch; 
  frm.firstName.value = "";
}
function submitSearch() 
    ...
    <div id="wrapper">
      <div id="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="col-sm-12">
              <div class="card">
                <div class="card-block">
                        <form name="frmpatientcreditsearch" method="post" action="" class="form-inline" onsubmit="return submitSearch();" > 
                        <input type="hidden"  name="clsaxAdmin_submitted" value=""> 
                          <div class="form-group m-r-15">
                                ...
                                <div class="form-group m-r-15">
                                <input type="date" class="form-control input-rounded" name="insDate"   value="<?php echo $this->patients_model->insDate?>"></div>
                        
                           
                            <button type="submit" class="btn btn-mini btn-primary waves-effect waves-light m-r-30">Search</button>
                            <button type="button" class="btn btn-mini btn-primary waves-effect waves-light m-r-30" onclick="javascript:document.location.href='<?php echo base_url('admin/patientcredits'); ?>';">Cancel</button>
                        </form>
              </div>
              ...
              <div class="table-responsive">
                ...
                <?php } ?>
                <form  method="post"  name="frmpatientCreditList" action=""> 
                ...
                <input type="hidden"  name="patientCreditId" value=""> 
                  ...
                  <thead>
                    <tr>
                      ...
                      <th width="2%" height="24" class="nosort">
                        <input type="checkbox" name="chkAll" value="checkbox" class="checkall"   onClick="selectAll(patientCreditId, this);">         
                      </th> 
          ...
          <?php
           global $arrAdminType;
                    if(count($patientcredit)) :
                    //$cnt=1; 
                    foreach ($patientcredit as $row) :
            ...
            <input type="checkbox" name="patientCreditId[]" value="<?php echo $row["patientCreditId"]?>" id="patientCreditId" onCLick='resetChkBox(patientCreditId, chkAll);changeCheckedColor(frmpatientCreditList.patientCreditId);' />
            </td> 
           ...
           <?php 
               ...
               <div class="card-block">
                    ...
                    <select name="clsaxpatientCreditId_pageSize"   class="form-control-list"> 
                        <?php echo $pageRange?> 
                    </select> 
  ...
  document.frmpatientcreditsearch.Submit.focus();
