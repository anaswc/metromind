...
$this->medicalRegistrationNumber					= $this->input->post_get('medicalRegistrationNumber');
	...
	public function setDoctor()
		...
		$symptomIds						= $this->input->post('symptomIds');
			...
			$this->doctorPassword=passEncrypt($this->input->post_get('doctorPassword'));
			$status =1;
...
//echo $availableDay;exit;
			...
			if($_POST['Morning_Start']<>"00:00" && $_POST['Morning_End']<>"")
			{
			...
			if($_POST['AfterNoon_Start']<>"00:00" && $_POST['AfterNoon_End']<>"")
			{
			$data = array(
				'doctorId' => $doctorId,
				'availableDay'    => $availableDay,
				'availableSession'      => 'After Noon',
			...
			if($_POST['Evening_Start']<>"00:00" && $_POST['Evening_End']<>"")
			{
			$data = array(
				'doctorId' => $doctorId,
				'availableDay'    => $availableDay,
				'availableSession'      => 'Evening',
			...
			if($_POST['Night_Start']<>"00:00" && $_POST['Night_End']<>"")
			{
			$data = array(
				'doctorId' => $doctorId,
				'availableDay'    => $availableDay,
