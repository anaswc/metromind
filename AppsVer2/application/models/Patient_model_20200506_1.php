...
//	End of get_patient_requested_fixed_appointments
	...
	{	
        ...
        if($this->communicationStartTime <> '')
            ...
            $this->db->where('"'.$this->communicationStartTime.'" BETWEEN appointmentStartTime AND appointmentEndTime');
		...
		if($query->num_rows() > 0){	
			...
			if($sessionDuration <> '')
				$this->appointmentEndTime = strtotime($this->communicationStartTime.' + '.$sessionDuration.' minute');
