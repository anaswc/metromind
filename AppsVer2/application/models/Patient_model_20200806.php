...

	{
		...
		if($this->communicationMode <> 3){	
			...
			if($this->appointmentId == 0){
				...
				$this->errorMessage =  $this->communicationDate;

				return 0;	

			}else if($this->check_doctor_availabilty($this->doctorId)){

				$this->errorMessage = 'Doctor is not available at the moment. Please schedule your appointment! 2';

				return 0;	

			}else if($this->doctorLoginStatus == 0){

				$this->errorMessage = 'Doctor is not available at the moment. Please schedule your appointment! 3';

				return 0;	

			}else if($this->check_appoitment_availability($this->patientId,$this->doctorId)){

				$this->errorMessage = 'Doctor is not available at the moment. Please schedule your appointment! 4';
