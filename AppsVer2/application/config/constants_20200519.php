...
defined('RAZORAPIKEY')    		OR define("RAZORAPIKEY","rzp_test_JPFeqfOVjTGMci");

defined('RAZORSECRETKEY')    	OR define("RAZORSECRETKEY","sAvN0VtKYJpKITXBJACKcW1t");
...
const  HTTP_STATUS_CODES  = array(
	...
	460 => "You missed out on these details!",

	461 => "Phone number already registered! Please login or retry with another Phone number",
	...
	480 => "This email does not seem right with us. Please enter another email",

	481 => "Go ahead!",

	482 => "This mobile number does not seem right with us. Please enter another mobile number",
